  ...
  >
    <g id="MorphingLogo">
      <g id="LogoHorizontal">
        ...
        />
        <path
          d="M68.13,27.61c-.13,0-.25,0-.38-.01-.93.03-1.94-.14-2.9-.49-.95-.38-1.78-.92-2.49-1.61l1.4-1.43c.52.51,1.13.91,1.8,1.18.69.25,1.45.37,2.23.36.99.06,1.88-.16,2.66-.63.63-.46.86-1.41.46-2.18-.09-.15-.27-.32-.47-.43-.38-.23-.76-.39-1.16-.49-.62-.17-1.28-.32-1.79-.42-.69-.13-1.29-.27-1.84-.43-.48-.12-.96-.32-1.42-.58-.45-.27-.81-.64-1.06-1.08-.26-.54-.37-1.07-.34-1.59,0-.47.09-.98.28-1.48.26-.55.61-.98,1.03-1.31.48-.37,1.01-.62,1.6-.76.69-.14,1.36-.21,2.04-.22.74,0,1.49.11,2.2.35.77.32,1.39.76,1.91,1.32l-1.47,1.36c-.32-.35-.71-.62-1.15-.81-.43-.14-.94-.22-1.47-.22-.54,0-1.09.06-1.62.17-.28.07-.56.2-.81.4-.17.13-.32.31-.41.51-.07.19-.12.45-.11.72-.01.26.03.46.11.64.05.07.17.2.31.28.28.16.59.29.93.38.53.15,1.05.28,1.68.4.55.1,1.27.27,1.92.45.57.15,1.13.38,1.64.69.49.27.92.69,1.23,1.2.88,1.69.39,3.75-1.12,4.82-1.08.65-2.24.97-3.41.97Z"
        />
        <polygon

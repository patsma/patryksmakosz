    ...
    <g id="Layer_2" data-name="Layer 2">
      <g id="zaksa-logo">
        ...
        <g id="char">
          <path
            id="char-fill-leg-l"
            d="M237.79,319.73l.14.35,4.27-.5,13.53,28.32,8.81,7.18,15.76-1.89,35.63-6.69a7.15,7.15,0,0,0,5.7-8.35c0-.12,0-.23-.07-.35L320.4,333l-35.63-1.88-16.06,5.48-2.41-19.81-.28-4.13C256,311.06,245.4,313.33,237.79,319.73Z"
            fill="#203063"
          />
          <path
            id="char-fill"
          ...
          <g id="char-outline">
            <g id="torso">
              <path
                d="M237.09,315.18c-6.31-10.82-32.35-71.81-21-125.57-21.75,41.72,12.07,120.19,18.84,132.5,3,5.41,30.57-8,32.05-15.73C258.93,312.63,240.58,321.17,237.09,315.18Z"
                fill="#fff"
              />
              <path
                d="M280.9,182.69c2.16,24.86-29.45,45.19-41.06,55.48C277.81,216.88,286.84,197.6,280.9,182.69Z"
                fill="#fff"
              />
              <path
                d="M264.51,264c2.61-11.16-.53-8-6.51,5.61-4.52,10.3-1.77,17.57,3.57,27-.88-5.22-3.34-9.3-2.68-14.39C259.9,274.34,263,270.44,264.51,264Z"
                fill="#fff"
              />
              <path
                d="M214.57,198.24c.63,36,33.09-3.93,22.38-26.28C240.13,185.35,223,228.69,214.57,198.24Z"
                fill="#fff"
              />
              <path
                d="M216.87,260.05c-3.15,17.36,19.16,8.88,29.69,6.86C237.3,265.62,221,271.13,216.87,260.05Z"
                fill="#fff"
              />
            </g>
            <g id="leg-l">
              <path
                d="M262.61,351.63c-4.73-2.76-20.21-31.26-21.55-31.52-.81-.14-2.06.21-4.45,1,3.62,9.7,11.7,17.48,16,26.95,6.27,13.82,21.73,7.06,33.77,5C310.3,349,268.18,354.87,262.61,351.63Z"
                fill="#fff"
              />
              <path
                d="M322.6,331.18c-11.16-.15-19-3.68-33.06-3.41-11.37.2-18,5.94-18.86,3.48-1.75-4.93-1.43-12.88-5.15-17.14,2,9.54-2.11,21.36.38,31,5-14.38,31-12.59,40.67-11.65C318.52,334.65,328.39,331.26,322.6,331.18Z"
                fill="#fff"
              />
            </g>
            <g id="leg-r">
              <path
                d="M356.35,306.61c-2.58-1.77-3.94-3.19-7.42-7.18-3.73-4.26-8.27-2.81-12.57.32S326,302.33,319,301c-9.62-1.9-41.52-15.69-54.48-11.47,13.37,1.57,25,6.15,42.18,12.19,14.36,5.07,27.15,5.11,28.39,7.11,2.9,4.64,9.59,7.9,14,7.52-4.07-3-10-5-8.64-11.24s4-4,7.65-.07C354.3,311.5,360.41,309.44,356.35,306.61Z"
                fill="#fff"
              />
              <path
                d="M271.72,312.27c26.55.9,53.93-1,71.55,11.22C335.64,311.61,303.05,307.32,271.72,312.27Z"
                fill="#fff"
              />
            </g>
            <g id="head">
              <path
                d="M263,135.24a19.24,19.24,0,0,0-5.54,3.27c-1.21,1.12-4,3.26-4.3,3.6-6.29,7.39-6,6.45-6.75,8.06-.23.46-2.16,3.63-1.9,3.33,1.11-1.31-1.49,1.88-1.92,3.31-.8,2.67,3.81,3.81,5.83,4.91,2.58,1.4,2.14,2.54.64,5.29-2,3.64-6.77,3-10.2,2,2.93,1.12,6.85,2.4,9.78.71a34.7,34.7,0,0,0,7.55-6.65c-2.83-1-12.55-3-11-6.89,1.82-4.63,8-16,12.91-7.5.06-2.93.19-6.89,2.1-9.27,2.06-2.56,6.43-4.84,10.57-5.28A13.33,13.33,0,0,0,263,135.24Z"
                fill="#fff"
              />
              <path
                d="M274.3,134.57c16.34,6.42,13.14,29.17-5.3,37.27,13.6-2.79,18.46-10.73,19.65-16.1a17.46,17.46,0,0,0-13.1-20.93C275.14,134.71,274.72,134.63,274.3,134.57Z"
                fill="#fff"
              />
              <path
                d="M270.3,177c-.32,7.33-14.86-.78-20.09-5.22A29.32,29.32,0,0,0,266.3,182C270.58,183.05,273.42,180.86,270.3,177Z"
                fill="#fff"
              />
            </g>
            <g id="hand-l">
              <path
                d="M171,187.89c1.71,1.94,4.49,3.32,6.49,4.32-5.47,1.14-11.78,1.13-17.34,1.3-7.18.21-15.19-2.24-21.79-3.58-8-1.62-17.46-3-24.34-6.26-4.36-2.06-4.9-3.87-7.63-6.4a7.37,7.37,0,0,0-5.44-1.94c-2.1.16-4-1.77-2.51-1.74,6.25.14,9.57.74,14.09,3.75,3.84,2.55,9.43,5.51,15.31,5.13,7-.46,14.68-1,21.4.34,7.28,1.4,5.31,5.7,9.16,8.17-1.68-5.85,9-9.81,14-11.64a29.14,29.14,0,0,1,12.49-2.05c6.89.45,15.31-5,22.69-9.07,9.77-5.35,18.93-2.69,27.09-.43,0,0-14.82-7.69-24.11-4.68-5.29,1.71-12.52,8-17.62,10-4.33,1.69-5.67,1.9-10.4,2a37.41,37.41,0,0,0-10.14,1.55c-3.54,1.2-6,3.48-8.31,3.75-1.45.17-3.67-.51-5-.67a83.26,83.26,0,0,0-9.86-.62c-5.42.06-10.9.57-16.34.89-3.37.2-8.5,1.09-11.57.09-5.19-1.68-8.81-5.13-14.32-6.5a35.6,35.6,0,0,0-15.1.27c-2.33.59,1.33,1.55,2.14,1.84-1.54.33,1.2,1.44,2.41,1.53-.89.33,1.23,1.31,4.36,1.42,6,.21,5.69,5.74,12.06,6.88,5.43,1,11.57,2.75,16.74,4.19,8.54,2.37,17.56,6.47,27.1,6.65,15.29.29,53.54-7.52,65-15C194.78,189.56,178.17,191.29,171,187.89Z"
                fill="#fff"
              />
              <path
                d="M210.82,185.44c-2.49.52-3.71.64-6.2,1.16,9.22,3.47,14.07,6.49,20,14.54C222.75,194.91,218.36,188.2,210.82,185.44Z"
                fill="#fff"
              />
            </g>
            <g id="hand-r">
              <path
                d="M316.3,180.72c-1.69-10.28-1.05-18.53-5.12-26.73,2.92,11.12.28,23.23,3.06,29.7-4.38-4.15-17.11-.44-20.16-1.89-6.08-2.9-11.82-4.92-18.22-4.18,11,1.32,18,9.53,21.31,8.41,11.17-3.82,17,.55,25.25,5.83C320,188.17,317,185.25,316.3,180.72Z"
                fill="#fff"
              />
              <path
                d="M333,185.14c-3.05-12.7-12.7-31.17-17.2-41.7,1.9,12,8.85,25.35,12.77,37.31,2.09,6.37,2.26,10.84-.73,13-4.54,3.3-12.54,5.69-18.17,6.58-8.75,1.41-12.18-1.56-18.12-.45a23.13,23.13,0,0,0-11.24,5c3.19-1.45,9.3-3.25,13-2.66,7.9,1.23,11.48,1.68,19.35-.23,4.68-1.14,8.3-2.68,14.23-4.26C334.11,195.86,334.58,191.71,333,185.14Z"
                fill="#fff"
              />
              <path
                d="M311.8,118.44c-3-3.33-11.13-8.73-10.46-5.27s2.64,8.85,5.43,11.92c1,1.14-.56,2.56-1.36,4.68a17.23,17.23,0,0,1-2.49-1.76c-2.56-2.4-5.75-2.31-3.44,1.36,1.92,3,5.53,5.27,6.48,9,.82,3.24,1.16,5.77,4.67,6.47-2.39-1.49-2.89-4.19-4-8-.74-2.49-5.48-7.47-4.31-7.22,1.52.31,8.8,5.44,8.52,4.41-.24-.85-1.39-1.73-2.78-2.62a25.84,25.84,0,0,1,3.06-4c1.38-1.54-2.57-5.24-5.24-8a10.7,10.7,0,0,1-3-5.46c-.18-1.67,4.14,1.62,7.17,5-2.41-1.59-7.26-4.36-4.06-.2-1.53-3.21,4.86,1.78,6.42,3.57,2.18,2.52,4,13.77,2.52,25.72C320.65,134.12,315.49,122.49,311.8,118.44Z"
                fill="#fff"
              />
            </g>
          </g>
        ...
        <g id="text-zaksa">
          ...
          <g id="letters">
            <path
              id="letter-z"
              d="M88.13,278.51h36.06c5.84,0,5.81,8.84,2.33,11.37L101,310.44l-.09.61h28.3v9.08H92.75c-8.67-.05-7.55-7.94-5.59-9.93l26.72-21.67L114,288H88.13v-9.43Z"
              fill="#fff"
              fill-rule="evenodd"
            />
            <path
              id="letter-a"
              d="M171.45,282.54c-.8-2.22-3-3.89-6.6-4a86.69,86.69,0,0,0-9.4,0,8.63,8.63,0,0,0-7.44,4l-16.5,37.58H143.3l3.5-8.44h26.06l3.58,8.44H188.3ZM150.2,303.81l6.1-14.55c1.17-2.69,6-2.73,6.85-.14l6.28,14.69Z"
              fill="#fff"
              fill-rule="evenodd"
            />
            <path
              id="letter-k"
              d="M190.51,278.51h11v17.06h2.79c1.73,0,3.19-1.43,4.18-2.8l11.12-14.23h14.7l-18.65,20.27,21.28,21.34H222l-13-14a6.44,6.44,0,0,0-4.27-2.29c-1-.17-1.92,0-3.2-.08v16.38h-11V278.51Z"
              fill="#fff"
              fill-rule="evenodd"
            />
            <path
            ...
            <path
              id="letter-a-2"
              d="M324.44,282.54c-.8-2.22-3-3.89-6.6-4a86.88,86.88,0,0,0-9.41,0,8.63,8.63,0,0,0-7.44,4l-16.5,37.58H296.3l3.5-8.44h26.06l3.58,8.44H341.3Zm-21,21.27,6.08-14.55c1.17-2.69,6-2.73,6.85-.14l6.28,14.69Z"
              fill="#fff"
              fill-rule="evenodd"
            />
          </g>
        ...
        <g id="ball">
          <path
            id="ball-right"
            d="M220.85,110.72a19.65,19.65,0,0,1-21.55,11.91,16.72,16.72,0,0,0,2.5,1.26A18.14,18.14,0,0,0,218.75,92,19.63,19.63,0,0,1,220.85,110.72Z"
            fill="#fff"
          />
          <path
            id="ball-left"
            d="M192.74,109.67a17.2,17.2,0,0,1,7.84-20,17.48,17.48,0,0,0-2.38.55,15.87,15.87,0,0,0,6.37,30.93A17.18,17.18,0,0,1,192.74,109.67Z"
            fill="#fff"
          />
          <path
            id="ball-top"
            d="M207.17,93.05A14.22,14.22,0,0,1,220,105.37a13.15,13.15,0,0,0-25.37-6.87A14.22,14.22,0,0,1,207.17,93.05Z"
            fill="#fff"
          />
        </g>
        <g id="shine">

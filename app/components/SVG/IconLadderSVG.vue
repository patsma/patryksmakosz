<template>
  <svg ref="svgRootRef" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 665 665">
    <defs>
    ...
    <g id="Layer_2" data-name="Layer 2">
      <g id="Layer_1-2" data-name="Layer 1">
        <g>
          <!-- Motion path lines (invisible, used for animation reference) -->
          ...
          <!-- Main dashboard/staircase structure -->
          <g>

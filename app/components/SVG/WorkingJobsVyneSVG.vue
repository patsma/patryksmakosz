<template>
  <!-- Inline SVG extracted from old portfolio art-tech project -->
  <!-- We add refs so parent component can query internals safely -->
  <svg
    ref="svgRootRef"
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 1251.03 250"
  >
    <defs>
      <mask
        id="mask"
      ...
      >
        <g id="mask-2" data-name="mask">
          ...
          />
          <path
            d="M508.18,77.61V30.7a89.21,89.21,0,0,0-15.38-1.55,87,87,0,0,0-15.52,1.55V125a87,87,0,0,0,15.52,1.54A89.2,89.2,0,0,0,508.18,125Z"
            fill="#fff"
          />
          <path
            d="M353.37,85.31h0a31,31,0,0,0,11.88-24c0-17.86-16.07-32.48-35.9-32.48h-2a197.44,197.44,0,0,0-22.54,1.47l8.6,21a18.22,18.22,0,0,1,3.3-.27C326.83,51,335,58,335,66.62c0,7.79-6.87,14.23-15.71,15.34l18,43.21a61.4,61.4,0,0,0,8.43,1.13c3.17.25,5.89.34,9.31.34,2.8,0,5.69-.13,8.68-.37a69.8,69.8,0,0,0,8.14-1.1Z"
            fill="#fff"
          />
          <path
            d="M739.17,50.23a16.86,16.86,0,1,1-17.32-16.39h.52A16.48,16.48,0,0,1,739.17,50h0Zm-29.5,0c0,7.3,5.4,13.09,12.8,13.09,7.2,0,12.5-5.79,12.5-13s-5.3-13.2-12.6-13.2S709.67,43,709.67,50.23Zm10.1,8.6H716V42.43a33.27,33.27,0,0,1,6.3-.5c3.1,0,4.5.5,5.7,1.2a4.55,4.55,0,0,1,1.6,3.6c0,1.8-1.4,3.2-3.4,3.8v.2c1.6.6,2.5,1.8,3,4,.5,2.5.8,3.5,1.2,4.1h-4.1c-.5-.6-.8-2.1-1.3-4-.3-1.8-1.3-2.6-3.4-2.6h-1.8Zm.1-9.3h1.8c2.1,0,3.8-.7,3.8-2.4,0-1.5-1.1-2.5-3.5-2.5a9.23,9.23,0,0,0-2.1.2Z"
            fill="#fff"
          />
        </g>
      </mask>
      ...
      >
        <g id="mask-3-2" data-name="mask-3">
          <g
            id="right_green_triangle_mask"
            data-name="right green triangle mask"
          >
      ...
      <linearGradient
        ...
        x2="1223.04"
        y2="-540.4"
        gradientTransform="matrix(1, 0, 0, -1, -737.86, -424.37)"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset="0" stop-color="#005995" />
      ...
      <linearGradient
        ...
        x2="626.37"
        y2="63.01"
        gradientTransform="matrix(1, 0, 0, -1, -114.32, 181.47)"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset="0" stop-color="#005995" />
              ...
              <g mask="url(#mask)">
                <g id="working_solutions-2" data-name="working solutions-2">
                  ...
                  <g id="blues">
                    ...
                    />
                    <path
                      d="M381.21,194.69h19.36v7.42H372.22V152.6h9Z"
                      fill="#005597"
                    />
                    <path
                      d="M434.94,194.21a11.85,11.85,0,0,0,4.67-.87,9.6,9.6,0,0,0,3.47-2.44,10.81,10.81,0,0,0,2.18-3.81,15.71,15.71,0,0,0,.75-5V152.6h9v29.47a22.49,22.49,0,0,1-1.38,8,17.76,17.76,0,0,1-10.32,10.46,24.16,24.16,0,0,1-16.72,0,17.69,17.69,0,0,1-10.28-10.46,22.49,22.49,0,0,1-1.38-8V152.6h9V182a15.71,15.71,0,0,0,.75,5,10.81,10.81,0,0,0,2.16,3.82,9.53,9.53,0,0,0,3.46,2.46A11.76,11.76,0,0,0,434.94,194.21Z"
                  ...
                  <g id="green_triangles" data-name="green triangles">
                    <g mask="url(#mask-3)">
                      <rect
                        id="left_green_rectangle"
                        data-name="left green rectangle"
                        width="379.37"
                        height="250"
                        fill="#4cb648"
                      />
                    ...
                    <g mask="url(#mask-4)">
                      <rect
                        id="right_green_rectangle"
                        data-name="right green rectangle"
                        x="379.37"
                        width="379.37"
                        height="250"
                  ...
                  <g id="blue_triangles" data-name="blue triangles">
                    <g
                      id="left_green-blue_rectangle"
                      data-name="left green-blue rectangle"
                    >
                    ...
                    <g
                      id="right_green-blue_rectangle"
                      data-name="right green-blue rectangle"
                    >
                  ...
                  <rect
                    id="rectangle_purple-blue"
                    data-name="rectangle purple-blue"
                    x="270.34"
                    y="40.07"
                    width="214.84"
                    height="151.92"
                  ...
                  />
                  <rect
                    id="rectangle_blue-darkblue"
                    data-name="rectangle blue-darkblue"
                    x="242.95"
                    y="14.29"
                    width="269.1"
                    height="208.33"
                  ...
                  />
                  <rect
                    id="rectangle_darkblue"
                    data-name="rectangle darkblue"
                    x="245.58"
                    y="9.4"
                    width="257.11"
                    height="199.05"
                    transform="translate(-5.98 23.18) rotate(-3.52)"
                    fill="#005894"
                  />
...
<script setup>
// Expose the root SVG and main group so parent can query by IDs

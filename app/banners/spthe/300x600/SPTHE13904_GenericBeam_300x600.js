...
tl
    ...
    .to('',0.5,{})
    .add('laser-movement')
    .to('#laser-beam',0.2,{y:5,ease: Power0.easeNone})
    .to('#laser-beam',0.2,{xPercent:-1,ease: Power0.easeNone})
    .to('#laser-beam',0.2,{y:-7,ease: Power0.easeNone})
    .to('#laser-beam',0.2,{xPercent:-3,ease: Power0.easeNone})
    .to('#laser-beam',0.2,{y:8,ease: Power0.easeNone})
    .to('#laser-beam',0.2,{xPercent:-5,ease: Power0.easeNone})
    .to('#laser-beam',0.2,{y:-9,ease: Power0.easeNone})
    .to('#laser-beam',0.2,{xPercent:-7,ease: Power0.easeNone})
    .to('#laser-beam',0.2,{y:5,ease: Power0.easeNone})
    .to('#laser-beam',0.2,{xPercent:-9,ease: Power0.easeNone})
    .to('#laser-beam',0.2,{y:-5,ease: Power0.easeNone})
    .to('#laser-beam',0.2,{xPercent:-11,ease: Power0.easeNone})
    .to('#laser-beam',0.2,{y:0,ease: Power0.easeNone})
    .from(s01t02,1,{yPercent:3,autoAlpha:0})
    .to("rect", 3.2, {attr:{x:27}},'laser-movement-=0.2')

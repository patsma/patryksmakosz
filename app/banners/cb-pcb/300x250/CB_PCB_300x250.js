...
tl01
    ...
    .to(s01t01,1,{yPercent:-10,autoAlpha:1},'show-mask01+=0.5')
...
tl02
    ...
    .to(s01t02,1,{yPercent:-10,autoAlpha:1},'show-mask02+=0.5')
...
tl03
    ...
    .to(s01t03,1,{yPercent:-10,autoAlpha:1},'show-mask03+=0.5')
...
tl04
    ...
    .to(s01t04,1,{yPercent:-10,autoAlpha:1},'show-mask04+=0.5')
...
master.add(tl01.tweenFromTo(0.4));
master.add(tl02,'-=.6');
master.add(tl03,'-=.6');
master.add(tl04,'-=.6');

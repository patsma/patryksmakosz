...
tl
    ...
    .to({}, {duration: 0.2})
    .fromTo(s02t01, {autoAlpha: 0, xPercent: 10}, {autoAlpha: 1, xPercent: 0, duration: 0.8})
    .to({}, {duration: 0.6})
    .fromTo([s03t01, s03t02], {autoAlpha: 0, xPercent: -10}, {autoAlpha: 1, xPercent: 0, duration: 0.8})
    .to({}, {duration: 1});

...
<template>
  ...
  <div>
    <main>
      ...
      <p class="description">
        Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://tasty-0a.sentry.io/issues/?project=4510003720486992">Issues Page</a>.
